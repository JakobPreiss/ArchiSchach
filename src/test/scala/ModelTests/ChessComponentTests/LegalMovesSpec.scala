    ...
    "Legal Moves " should {
        "return all legal moves for fens" in {
           val expected: List[(Int, Int)] = List((24, 9), (24, 18), (24, 34), (55, 7), (55, 15), (55, 23), (55, 31), (55, 39), (55, 47), (55, 54), (55, 53), (55, 52), (55, 51), (55, 63), (50, 43), (50, 51), (50, 59), (61, 45), (61, 53), (61, 63), (61, 62), (61, 60), (61, 59), (58, 44), (58, 51), (58, 49), (37, 28), (30, 22), (41, 33), (40, 32)).sorted;
            ...
            LegalMoves.getAllLegalMoves(fen) match {
                case Failure(a) =>
                case Success(legalMoves) =>
                    legalMoves.sorted should be(expected);
            }
            ...
            LegalMoves.getAllLegalMoves(fen0) match {
                case Failure(e) =>
            ...
            LegalMoves.getAllLegalMoves(fen2) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected2)
            }

            val expected3: List[(Int, Int)] = List((45, 30), (45, 28), (45, 39), (45, 35), (45, 55), (45, 51), (45, 62), (45, 60), (54, 47), (54, 61), (50, 32), (50, 41), (50, 51), (50, 59), (50, 58), (63, 39), (63, 47), (63, 55), (63, 62), (63, 61), (63, 60), (63, 59), (63, 58), (57, 40), (57, 51), (12, 5), (46, 38), (43, 35), (42, 34), (49, 41), (48, 40), (49, 33), (48, 32)).sorted.distinct
            val fen3 = "1rb1kb1r/ppp1P2p/7n/n4ppP/8/2PP1NP1/PPQ1KPB1/RNq4R w - - 0 19"
            LegalMoves.getAllLegalMoves(fen3) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected3)
            }

            val expected4: List[(Int, Int)] = List((2, 1), (2, 11)).sorted
            val fen4 = "2k5/3R4/2R3K1/6b1/6b1/8/3P1r2/6NB b - - 6 116"
            LegalMoves.getAllLegalMoves(fen4) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected4)
            }
            ...
            LegalMoves.getAllLegalMoves(fen5) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected5)
            }

            val expected6: List[(Int, Int)] = List((56, 48), (56, 57), (19, 35), (51, 42)).sorted
            val fen6 = "6k1/8/P2R4/4b3/6P1/8/3B4/K7 w - - 3 101"
            LegalMoves.getAllLegalMoves(fen6) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected6)
            }
            ...
            LegalMoves.getAllLegalMoves(fen7) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected7)
            }
            ...
            LegalMoves.getAllLegalMoves(fen8) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected8)
            }
            ...
            LegalMoves.getAllLegalMoves(fen9) match {
                case Failure(e) =>
            ...
            val fen10 = "r1bqkbnr/pp1ppppp/2n5/2p5/8/2NP4/PPP2PPP/R1BQKBNR b KQkq - 2 4"
            ...
            LegalMoves.getAllLegalMoves(fen15) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected15)
            }
            ...
            LegalMoves.getAllLegalMoves(fen16) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected16)
            }
            ...
            LegalMoves.getAllLegalMoves(fen17) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected17)
            }
            ...
            LegalMoves.getAllLegalMoves(fen18) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected18)
            }
            ...
            LegalMoves.getAllLegalMoves(fen19) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected19)
            }
            ...
            LegalMoves.getAllLegalMoves(fen20) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected20)
            }
            ...
            LegalMoves.getAllLegalMoves(fen21) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected21)
            }
            ...
            LegalMoves.getAllLegalMoves(fen22) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected22)
            }
            ...
            LegalMoves.getAllLegalMoves(fen23) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected23)
            }
            ...
            LegalMoves.getAllLegalMoves(fen24) match {
                case Failure(e) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected24)
            }
            ...
            LegalMoves.getAllLegalMoves(fen25) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected25)
            }
            ...
            LegalMoves.getAllLegalMoves(fen26) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected26)
            }
            ...
            LegalMoves.getAllLegalMoves(fen27) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected27)
            }
            ...
            LegalMoves.getAllLegalMoves(fen28) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected28)
            }
            ...
            LegalMoves.getAllLegalMoves(fen29) match {
                case Failure(_) =>
            ...
            LegalMoves.getAllLegalMoves(fen35) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected35)
            }

            val expected36: List[(Int, Int)] = List((30, 23), (30, 22), (30, 31)).sorted
            val fen36 = "8/5R2/8/1P2P1k1/4R3/K6P/P7/8 b - - 6 88"
            LegalMoves.getAllLegalMoves(fen36) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected36)
            }
            ...
            LegalMoves.getAllLegalMoves(fen37) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected37)
            }
            ...
            LegalMoves.getAllLegalMoves(fen38) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected38)
            }
            ...
            LegalMoves.getAllLegalMoves(fen39) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected39)
            }

            val expected40: List[(Int, Int)] = List((34, 27), (34, 26), (34, 35), (34, 33), (34, 42), (34, 41)).sorted
            val fen40 = "2N4r/8/2B5/7k/2K5/8/8/5q2 w - - 10 164"
            LegalMoves.getAllLegalMoves(fen40) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected40)
            }
            ...
            LegalMoves.getAllLegalMoves(fen41) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected41)
            }
            ...
            LegalMoves.getAllLegalMoves(fen42) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected42)
            }
            ...
            LegalMoves.getAllLegalMoves(fen43) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected43)
            }
            ...
            LegalMoves.getAllLegalMoves(fen44) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected44)
            }
            ...
            LegalMoves.getAllLegalMoves(fen45) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected45)
            }
            ...
            LegalMoves.getAllLegalMoves(fen46) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected46)
            }
            ...
            LegalMoves.getAllLegalMoves(fen47) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected47)
            }
            ...
            LegalMoves.getAllLegalMoves(fen48) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected48)
            }
            ...
            LegalMoves.getAllLegalMoves(fen49) match {
                case Failure(_) =>
                case Success(legalMoves) => legalMoves.sorted should be(expected49)
            } */
